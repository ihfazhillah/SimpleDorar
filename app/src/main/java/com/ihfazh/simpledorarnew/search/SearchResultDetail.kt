...
import com.ihfazh.simpledorarnew.bookmark.BookmarkHadithBottomSheet
import com.ihfazh.simpledorarnew.databinding.FragmentSearchResultDetailBinding
import com.ihfazh.simpledorarnew.databinding.SampleDorarBinding
        ...
        binding?.share?.setOnClickListener {
            ...
            if (imageFile != null){
                val intent = Intent(Intent.ACTION_SEND).apply {
                    val uri = FileProvider.getUriForFile(requireContext(), requireActivity().packageName + ".com.ihfazh.simpledorarnew", imageFile)
