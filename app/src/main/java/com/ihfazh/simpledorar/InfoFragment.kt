...
import com.ihfazh.simpledorar.databinding.FragmentInfoBinding
import com.ihfazh.simpledorar.databinding.GeneralItemListBinding
...
class InfoFragment : Fragment() {
    ...
    private fun openRate(){
        val intent = Intent(Intent.ACTION_VIEW).apply {
            data = Uri.parse("https://play.google.com/store/apps/details?id=com.ihfazh.simpledorar")
